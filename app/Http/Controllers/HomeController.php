...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $activePakets     = Paket::active()->orderBy('sort_order')->orderBy('created_at', 'desc')->take(3)->get();
...
// Get stats from database - dynamic and conditional
        ...
        return view('home', compact('store', 'featuredServices', 'laptopServices', 'printerServices', 'pcServices', 'testimonials', 'stats_items', 'heroLaptop', 'heroPrinter', 'heroPc', 'activePakets'));
