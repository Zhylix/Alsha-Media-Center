        ...
        <div class="service-card p-6 rounded-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="username" required value="{{ old('username', $admin->username) }}"
                        class="form-input w-full px-4 py-3 rounded-xl text-sm"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-600 mb-2">Password (Kosongkan jika tidak berubah)</label>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1"><i class="fas fa-info-circle"></i> Anda tidak dapat menonaktifkan akun sendiri</p>
                    @endif
                </div>
            </div>
        </div>
