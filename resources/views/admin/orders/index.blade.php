    ...
    <div class="overflow-x-auto">
        <table class="admin-table w-full">
            ...
            <tbody>
                ...
                @endforeach
                @if($orders->isEmpty())
                <tr><td colspan="6" class="text-center text-gray-500 py-10">Belum ada pesanan</td></tr>
                @endif
            </tbody>
        </table>
    </div>
