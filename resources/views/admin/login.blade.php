...
<body class="bg-hero min-h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-md px-4">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black text-gray-900">Admin <span class="text-gradient">Alsha Media Center</span></h1>
            <p class="text-gray-500 text-sm mt-1">Panel Administrasi — Akses Terbatas</p>
        </div>
        ...
        <div class="service-card p-8 rounded-2xl">
            ...
            @endif
            @if(session('success'))
            <div class="mb-5 flex items-center gap-3 px-4 py-3 bg-red-600/10 border border-red-600/30 rounded-xl text-red-600 text-sm">
        ...
        <p class="text-center text-gray-500 text-xs mt-6">
            <a href="{{ route('home') }}" class="hover:text-gray-600 transition-colors"><i class="fas fa-arrow-left"></i> Kembali ke Website</a>
        </p>
    </div>
</body>
</html>
