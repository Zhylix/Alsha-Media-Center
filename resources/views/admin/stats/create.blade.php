...
@section('page-subtitle', 'Form penambahan statistik baru')

@section('content')
<div class="max-w-3xl">
    <form method="POST" action="{{ route('admin.stats.store') }}" class="space-y-6">
        @csrf
        <div class="service-card p-8 rounded-2xl space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" required class="form-input w-full px-4 py-3 rounded-xl text-sm" placeholder="Contoh: fas fa-clock">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="label" value="{{ old('label') }}" required class="form-input w-full px-4 py-3 rounded-xl text-sm" placeholder="Contoh: Tahun Pengalaman">
                ...
                <div>
                    ...
                    <input type="text" name="value" value="{{ old('value') }}" required class="form-input w-full px-4 py-3 rounded-xl text-sm" placeholder="Contoh: 10">
        ...
        <div class="flex gap-4">
            ...
            <button type="submit" class="btn-primary flex-1 py-3 rounded-xl text-white font-semibold text-sm">Simpan Stat</button>
        </div>
    </form>
</div>
@endsection
