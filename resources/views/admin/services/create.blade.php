            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="category" required class="form-input w-full px-4 py-3 rounded-xl text-sm">
                        ...
                        <option value="laptop" {{ old('category') === 'laptop' ? 'selected' : '' }}><i class="fas fa-laptop text-blue-400"></i> Laptop</option>
                        <option value="printer" {{ old('category') === 'printer' ? 'selected' : '' }}><i class="fas fa-print text-purple-400"></i> Printer</option>
                        <option value="hp" {{ old('category') === 'hp' ? 'selected' : '' }}><i class="fas fa-mobile-alt text-green-400"></i> HP</option>
                    </select>
                </div>
                <div>
