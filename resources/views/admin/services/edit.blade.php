        ...
        <div class="service-card p-8 rounded-2xl space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-slate-400 mb-2">Nama Layanan *</label>
                ...
                <div>
                    ...
                    <select name="category" required class="form-input w-full px-4 py-3 rounded-xl text-sm">
                        <option value="laptop" {{ $service->category === 'laptop' ? 'selected' : '' }}><i class="fas fa-laptop text-blue-400"></i> Laptop</option>
                        <option value="printer" {{ $service->category === 'printer' ? 'selected' : '' }}><i class="fas fa-print text-purple-400"></i> Printer</option>
                        <option value="hp" {{ $service->category === 'hp' ? 'selected' : '' }}><i class="fas fa-mobile-alt text-green-400"></i> HP</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-400 mb-2">Estimasi Hari *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-400 mb-2">Harga Mulai (Rp) *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-400 mb-2">Harga Maksimal (Rp)</label>
                ...
                <div class="sm:col-span-2">
                    <label class="block text-sm font-medium text-slate-400 mb-2">Deskripsi Lengkap *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-400 mb-2">Urutan Tampil</label>
                ...
                <div class="flex items-center gap-6 pt-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-slate-300 text-sm">Aktif</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_featured" class="w-4 h-4 rounded" {{ $service->is_featured ? 'checked' : '' }}>
                        <span class="text-slate-300 text-sm"><i class="fas fa-star text-yellow-400"></i> Featured</span>
                    </label>
                </div>
            </div>
        </div>
        <div class="flex gap-4">
            <a href="{{ route('admin.services.index') }}" class="btn-outline flex-1 text-center py-3 rounded-xl text-white font-semibold text-sm"><i class="fas fa-arrow-left"></i> Batal</a>
