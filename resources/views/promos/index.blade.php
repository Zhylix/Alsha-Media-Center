    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div class="max-w-xl">
            ...
            <h1 class="text-5xl sm:text-6xl font-black text-gray-900 tracking-tight leading-tight mb-5">
                Promo <span class="text-[#C8000A]">Spesial</span><br>Menanti Anda
            </h1>
            <p class="text-gray-400 text-lg leading-relaxed">
                Nikmati potongan harga dan penawaran menarik khusus untuk layanan perbaikan elektronik di Alsha Media Center.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div class="flex items-center justify-between mb-10">
            <p class="text-sm text-gray-400 font-medium">
                Menampilkan <strong class="text-gray-800">{{ $promos->count() }}</strong> promo aktif
            </p>
            ...
            <div class="group bg-white border border-gray-100 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-gray-200/80 hover:border-gray-200 flex flex-col h-full relative">
                ...
                <div class="p-7 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto space-y-4">
                        ...
                        <!-- CTA -->
                        <a href="https://wa.me/{{ preg_replace('/\D/','',$store->whatsapp ?? '6281234567890') }}?text=Halo%20AMC,%20saya%20ingin%20klaim%20promo%3A%20{{ urlencode($promo->title) }}" 
                           target="_blank" 
