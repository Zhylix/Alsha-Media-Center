...
<section class="relative py-32 bg-hero overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex items-center gap-2 text-gray-500 text-sm mb-6">
            <a href="{{ route('home') }}" class="hover:text-gray-900">Beranda</a> / <a href="{{ route('services.index') }}" class="hover:text-gray-900">Layanan</a> / <span class="text-red-600">Laptop</span>
        </div>
        <div class="flex items-center gap-4 mb-4"><span class="text-6xl animate-float"><i class="fas fa-laptop text-red-600"></i></span><span class="badge badge-gray text-base px-4 py-2">Service Laptop</span></div>
        <h1 class="text-4xl sm:text-5xl font-black text-gray-900 mb-4">Jasa Service <span class="text-gradient">Laptop</span> Profesional</h1>
        <p class="text-gray-600 text-lg max-w-2xl">Semua merek laptop ditangani: Asus, Acer, Lenovo, HP, Dell, MSI, Apple MacBook, dan lainnya.</p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="service-card p-6 rounded-2xl group" data-animate>
                <div class="flex items-start justify-between mb-4">
                    <div class="w-12 h-12 rounded-xl bg-red-600/10 border border-red-600/20 flex items-center justify-center text-2xl"><i class="fas fa-laptop text-red-600"></i></div>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-animate>
        <h2 class="text-2xl font-black text-gray-900 mb-8">Merek yang Kami Tangani</h2>
