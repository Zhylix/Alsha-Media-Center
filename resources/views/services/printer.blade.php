...
<section class="relative py-32 bg-hero overflow-hidden">
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute top-1/3 left-1/4 w-72 h-72 bg-purple-600/10 rounded-full blur-3xl"></div>
    </div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex items-center gap-2 text-slate-500 text-sm mb-6">
            <a href="{{ route('home') }}" class="hover:text-white">Beranda</a> / <a href="{{ route('services.index') }}" class="hover:text-white">Layanan</a> / <span class="text-purple-400">Printer</span>
        </div>
        <div class="flex items-center gap-4 mb-4"><span class="text-6xl animate-float"><i class="fas fa-print text-purple-400"></i></span><span class="badge badge-purple text-base px-4 py-2">Service Printer</span></div>
        <h1 class="text-4xl sm:text-5xl font-black text-white mb-4">Jasa Service <span class="text-gradient">Printer</span> Profesional</h1>
        <p class="text-slate-400 text-lg max-w-2xl">Semua merek printer ditangani: Canon, Epson, HP, Brother, Xerox, dan lainnya.</p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="service-card p-6 rounded-2xl group" data-animate>
                <div class="flex items-start justify-between mb-4">
                    <div class="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-2xl"><i class="fas fa-print text-purple-400"></i></div>
                ...
                <div class="border-t border-purple-500/10 pt-4 flex items-center justify-between">
                    <div>
                        <p class="text-purple-400 font-bold">{{ $service->price_range }}</p>
...
<section class="py-16 bg-slate-900/30">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-animate>
        <h2 class="text-2xl font-black text-white mb-8">Merek Printer yang Kami Tangani</h2>
