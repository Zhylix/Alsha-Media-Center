    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-gray-200 text-lg leading-relaxed mb-8 animate-fade-up" style="animation-delay: 0.2s;">
                ...
                <div class="flex flex-wrap gap-3 animate-fade-up" style="animation-delay: 0.4s;">
                    <a href="{{ route('services.laptop') }}" class="flex items-center gap-2 px-4 py-2 bg-white/10 border-white/20 text-white hover:bg-white/20 rounded-xl transition-all text-sm"><i class="fas fa-laptop text-red-500"></i> Laptop</a>
                    <a href="{{ route('services.printer') }}" class="flex items-center gap-2 px-4 py-2 bg-white/10 border-white/20 text-white hover:bg-white/20 rounded-xl transition-all text-sm"><i class="fas fa-print text-red-500"></i> Printer</a>
                    <a href="{{ route('services.hp') }}" class="flex items-center gap-2 px-4 py-2 bg-white/10 border-white/20 text-white hover:bg-white/20 rounded-xl transition-all text-sm"><i class="fas fa-mobile-alt text-red-500"></i> HP</a>
                </div>
            </div>
