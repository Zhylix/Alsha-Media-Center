...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14" data-animate>
            <span class="text-red-600 text-sm font-bold uppercase tracking-widest"><i class="fas fa-tasks mr-1"></i> Cara Kerja</span>
            <h2 class="text-3xl sm:text-4xl font-black text-gray-900 mt-3">Proses <span class="text-gradient">Mudah & Cepat</span></h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            ...
            @foreach([
                ['step' => '01', 'icon' => '<i class="fas fa-file-alt text-white"></i>', 'title' => 'Pilih Layanan', 'desc' => 'Pilih jenis service yang Anda butuhkan'],
                ['step' => '02', 'icon' => '<i class="fas fa-box text-white"></i>', 'title' => 'Kirim Perangkat', 'desc' => 'Antar langsung atau gunakan jasa pengiriman'],
                ['step' => '03', 'icon' => '<i class="fas fa-wrench text-white"></i>', 'title' => 'Proses Perbaikan', 'desc' => 'Teknisi kami mengerjakan dengan profesional'],
                ['step' => '04', 'icon' => '<i class="fas fa-check text-white"></i>', 'title' => 'Terima Kembali', 'desc' => 'Perangkat Anda siap diambil atau dikirim balik'],
            ] as $step)
